...
/// A struct that represents the response from a license deactivation request.
public struct DeactivateResponse: Decodable {
    /// A Boolean value that indicates whether the deactivation was successful.
    public let deactivated: Bool
    
    /// An object that contains information about the deactivated license key.
    public let licenseKey: LicenseKey?
    
    /// An object that contains information about the deactivated instance.
    public let instance: Instance?
    
    /// An object that contains metadata about the deactivation.
    ...
    /// A struct that represents an instance of a deactivated license.
    ...
    /// A struct that contains metadata about the license deactivation.
