...
/// A struct that represents the response from a license validation request.
public struct ValidateResponse: Decodable {
    /// A Boolean value that indicates whether the license is valid.
    public let valid: Bool
    
    /// An object that contains information about the validated license key.
    public let licenseKey: LicenseKey?
    
    /// An object that contains information about the validated instance, if applicable.
    public let instance: Instance?
    
    /// An object that contains metadata about the validation.
    ...
    /// A struct that represents an instance of a validated license.
    ...
    /// A struct that contains metadata about the license validation.
